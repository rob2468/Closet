...
protocol CJProductEditControllerDelegate: AnyObject {
    func onProductEditControllerDismiss() -> Void
}

class CJProductEditController: UIViewController {

    var headerContentView: UIView!
    weak var delegate: CJProductEditControllerDelegate?
